                        ...
                        crate::op::InnerContent::List(l) => match l {
                            list_op::InnerListOp::InsertText {
                                ...
                                let event_index = self
                                    .state
                                    .get_mut()
                                    .entity_index_to_event_index(*pos as usize);
                                if event_index > 0 {
                            ...
                            list_op::InnerListOp::Delete(del) => {
                                ...
                                let event_start =
                                    self.state.get_mut().entity_index_to_event_index(start);

                                // Calculate how many event units we're deleting
                                let event_end = self
                                    .state
                                    .get_mut()
                                    .entity_index_to_event_index(start + len);
                                let event_len = event_end - event_start;

                                // Get the actual text content that will be deleted
                                let deleted_text =
                                    self.get_text_slice_by_event_index(event_start, event_len)?;
                            ...
                            list_op::InnerListOp::StyleStart {
                                ...
                                let event_start = self
                                    .state
                                    .get_mut()
                                    .entity_index_to_event_index(*start as usize);
                                let event_end = self
                                    .state
                                    .get_mut()
                                    .entity_index_to_event_index(*end as usize);
