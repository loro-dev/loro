...
pub fn test_multi_sites_with_gc(
        ...
        .is_multiple_of(1_000)
    {
        let must_meet = [
            ...
            "loro::internal::history_cache::find_text_chunks_in",
            "loro::internal::history_cache::find_list_chunks_in",
            "loro::internal::import",
            "loro::internal::import::fast_snapshot::decode_snapshot",
            "loro::internal::import::snapshot",
            "loro::internal::import::snapshot::gc",
            "loro::internal::import::snapshot::normal",
