    ...
    test_actions(vec![
        Handle {
            ...
            action: Generic(GenericAction {
                ...
                key: 4294967295,
                pos: 18446744073709551615,
                length: 651052016268738559,
                prop: 17224462720839292681,
            }),
        },
        SyncAll,
        SyncAll,
        Handle {
            ...
            action: Generic(GenericAction {
                ...
                bool: true,
                key: 151587072,
                pos: 18446744073608861079,
                length: 18446744073709551615,
                prop: 18446744069985009663,
            }),
        },
        SyncAll,
        Sync { from: 177, to: 177 },
        Sync { from: 173, to: 173 },
        Sync { from: 177, to: 177 },
        SyncAll,
        Handle {
            site: 0,
        ...
        Handle {
            ...
            action: Generic(GenericAction {
                ...
                key: 3752964529,
                pos: 167503732993,
                length: 17293822569102317567,
                prop: 650770146155036671,
            }),
        },
        Sync { from: 149, to: 151 },
        SyncAll,
        SyncAll,
        Handle {
            site: 9,
            ...
            action: Generic(GenericAction {
                ...
                bool: true,
                key: 2509608411,
                pos: 9481649060190852503,
                length: 651061555542741295,
                prop: 653927982358911753,
            }),
        },
        Sync { from: 163, to: 213 },
        Handle {
            site: 247,
            target: 213,
            container: 149,
        ...
        Handle {
            ...
            action: Generic(GenericAction {
                ...
                bool: true,
                key: 3688618971,
                pos: 3689348814741822427,
                length: 59606465652278,
                prop: 3689419196421505024,
            }),
        },
        Handle {
        ...
        Handle {
            ...
            action: Generic(GenericAction {
                ...
                bool: false,
                key: 4281742902,
                pos: 3689348816889394035,
                length: 15795024613113803563,
                prop: 15842497851538791387,
            }),
        },
        Sync { from: 14, to: 47 },
        SyncAll,
        Handle {
            ...
            container: 21,
            action: Generic(GenericAction {
                value: I32(1111638594),
                bool: false,
                key: 1027621442,
                pos: 1412894004757058,
                length: 651061555542450232,
                prop: 10798234466129621048,
            }),
        },
        Sync { from: 213, to: 23 },
        Handle {
