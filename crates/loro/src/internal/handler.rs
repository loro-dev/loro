...
impl From<&DeltaItem<StringSlice, StyleMeta>> for TextDelta {
    fn from(value: &DeltaItem<StringSlice, StyleMeta>) -> Self {
        match value {
            crate::internal::delta::DeltaItem::Retain { retain, attributes } => TextDelta::Retain {
                retain: *retain,
                attributes: attributes.to_option_map(),
            },
            crate::internal::delta::DeltaItem::Insert { insert, attributes } => TextDelta::Insert {
                insert: insert.to_string(),
                attributes: attributes.to_option_map(),
            },
            crate::internal::delta::DeltaItem::Delete {
                delete,
                attributes: _,
...
impl TextHandler {
    ...
    fn insert_with_txn_and_attr(
        ...
        txn.apply_local_op(
            inner.container_idx,
            crate::internal::op::RawOpContent::List(crate::internal::container::list::list_op::ListOp::Insert {
    ...
    fn delete_with_txn_inline(
        ...
        for range in ranges.iter().rev() {
            ...
            txn.apply_local_op(
                inner.container_idx,
                crate::internal::op::RawOpContent::List(ListOp::Delete(DeleteSpanWithId::new(
                    range.id_start,
    ...
    pub fn mark_with_txn(
        ...
        txn.apply_local_op(
            inner.container_idx,
            crate::internal::op::RawOpContent::List(ListOp::StyleStart {
            ...
            EventHint::Mark {
                ...
                style: crate::internal::container::richtext::Style { key, data: value },
            },
            &inner.doc,
        )?;
        ...
        txn.apply_local_op(
            inner.container_idx,
            crate::internal::op::RawOpContent::List(ListOp::StyleEnd),
            EventHint::MarkEnd,
            &inner.doc,
        )?;
...
impl ListHandler {
    ...
    fn apply_delta(
        ...
        delta: loro_delta::DeltaRope<
            ...
            crate::internal::event::ListDeltaMeta,
        >,
...
impl MovableListHandler {
    ...
    pub fn move_with_txn(&self, txn: &mut Transaction, from: usize, to: usize) -> LoroResult<()> {
        ...
        txn.apply_local_op(
            inner.container_idx,
            crate::internal::op::RawOpContent::List(crate::internal::container::list::list_op::ListOp::Move {
                from: op_from as u32,
                to: op_to as u32,
    ...
    pub fn set_with_txn(
        ...
        let op = crate::internal::op::RawOpContent::List(crate::internal::container::list::list_op::ListOp::Set {
            elem_id: elem_id.to_id(),
            value: value.clone(),
        });
    ...
    pub fn set_container_with_txn<H: HandlerTrait>(
        ...
        txn.apply_local_op(
            inner.container_idx,
            crate::internal::op::RawOpContent::List(crate::internal::container::list::list_op::ListOp::Set {
                elem_id: elem_id.to_id(),
                value: v.clone(),
            }),
            EventHint::SetList {
    ...
    fn insert_without_skipping(&self, key: &str, value: impl Into<LoroValue>) -> LoroResult<()> {
        match &self.inner {
            ...
            MaybeDetached::Attached(a) => a.with_txn(|txn| {
                ...
                txn.apply_local_op(
                    inner.container_idx,
                    crate::internal::op::RawOpContent::Map(crate::internal::container::map::MapSet {
                        key: key.into(),
...
pub mod counter {
    ...
    impl CounterHandler {
        ...
        fn increment_with_txn(&self, txn: &mut Transaction, n: f64) -> LoroResult<()> {
            ...
            txn.apply_local_op(
                inner.container_idx,
                crate::internal::op::RawOpContent::Counter(n),
                EventHint::Counter(n),
                &inner.doc,
            )
        }
    ...
    impl HandlerTrait for CounterHandler {
        ...
        fn attached_handler(&self) -> Option<&crate::internal::BasicHandler> {
            self.inner.attached_handler()
        }
        ...
        fn attach(
            &self,
            txn: &mut crate::internal::txn::Transaction,
            parent: &crate::internal::BasicHandler,
        ...
        fn doc(&self) -> Option<crate::internal::LoroDoc> {
            match &self.inner {
                MaybeDetached::Detached(_) => None,
                MaybeDetached::Attached(a) => Some(a.doc()),
            }
...
mod test {
    ...
    use crate::internal::cursor::PosType;
    use crate::internal::loro::ExportMode;
    use crate::internal::state::TreeParentId;
    use crate::internal::version::Frontiers;
    use crate::internal::LoroDoc;
    use crate::internal::{fx_map, ToJson};
