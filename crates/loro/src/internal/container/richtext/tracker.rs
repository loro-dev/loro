...
use crate::internal::{cursor::AbsolutePosition, VersionVector};
            ...
            if id_span.contains(id) {
                ...
                return Some(AbsolutePosition {
                    ...
                    side: if is_activated {
                        crate::internal::cursor::Side::Middle
                    } else {
                        crate::internal::cursor::Side::Left
                    },
                });
            }
...
#[cfg(test)]
mod test {
    use crate::internal::{container::richtext::RichtextChunk, vv};
