...
//! - Utf16 index
//!
//! In [crate::internal::op::Op], we always use entity index to persist richtext ops.
//!
...
use crate::internal::{change::Lamport, delta::StyleMeta, utils::string_slice::StringSlice, InternalString};
use fugue_span::*;
