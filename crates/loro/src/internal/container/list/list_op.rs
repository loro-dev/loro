...
/// It looks like [crate::internal::span::CounterSpan], but how should they merge ([Mergable] impl) and slice ([Sliceable] impl) are very different
///
/// len cannot be zero;
///
...
mod test {
    ...
    use crate::internal::{container::list::list_op::DeleteSpanWithId, op::ListSlice};
