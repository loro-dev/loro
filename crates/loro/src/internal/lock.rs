...
//!
//! The actual locking is backed by [`crate::internal::sync::Mutex`], which resolves to
...
use crate::internal::sync::ThreadLocal;
...
///
/// This type wraps [`crate::internal::sync::Mutex`], so it remains compatible with loom-based
/// concurrency testing.
#[derive(Debug)]
