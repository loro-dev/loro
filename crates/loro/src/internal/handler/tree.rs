...
impl TreeHandler {
    ...
    pub(crate) fn delete_with_txn(&self, txn: &mut Transaction, target: TreeID) -> LoroResult<()> {
        ...
        txn.apply_local_op(
            inner.container_idx,
            crate::internal::op::RawOpContent::Tree(Arc::new(TreeOp::Delete { target })),
    ...
    pub(crate) fn create_at_with_target_for_apply_diff(
        ...
        let children = a.with_txn(|txn| {
            ...
            txn.apply_local_op(
                inner.container_idx,
                crate::internal::op::RawOpContent::Tree(Arc::new(TreeOp::Create {
                    target,
    ...
    pub(crate) fn move_at_with_target_for_apply_diff(
        ...
        a.with_txn(|txn| {
            ...
            txn.apply_local_op(
                inner.container_idx,
                crate::internal::op::RawOpContent::Tree(Arc::new(TreeOp::Move {
                    target,
                    parent: parent.tree_id(),
                    position: position.clone(),
                })),
