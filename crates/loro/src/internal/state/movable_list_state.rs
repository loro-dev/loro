...
mod list_item_tree {
    ...
    use crate::internal::utils::query_by_len::{IndexQuery, QueryByLen};
    ...
    fn apply_diff_and_convert(
...

        {
            ...
            for (elem_id, delta_item) in diff.elements.into_iter() {
                let crate::internal::delta::ElementDelta {
                    pos,
                    value,
                    value_updated,
                    value_id,
...
#[cfg(test)]
mod test {
    use crate::internal::{loro::ExportMode, HandlerTrait, LoroDoc, ToJson};
    use serde_json::json;
