...
use crate::internal::container::idx::ContainerIdx;
use crate::internal::delta::{TreeDiff, TreeDiffItem, TreeExternalDiff};
use crate::internal::diff_calc::DiffMode;
use crate::internal::event::InternalDiff;
...
use crate::internal::{DocState, LoroDocInner};
...
impl ContainerState for TreeState {
    fn container_idx(&self) -> crate::internal::container::idx::ContainerIdx {
        self.idx
    }
    ...
    fn apply_diff_and_convert(
        &mut self,
        diff: crate::internal::event::InternalDiff,
    ...
    fn apply_local_op(&mut self, raw_op: &RawOp, _op: &Op) -> LoroResult<ApplyLocalOpReturn> {
        ...
        match &raw_op.content {
            crate::internal::op::RawOpContent::Tree(tree) => match &**tree {
                TreeOp::Create {
                    target,
                    parent,
                    position,
...
mod snapshot {
    ...
    impl FastStateSnapshot for TreeState {
        ...
        fn decode_snapshot_fast(
            idx: crate::internal::container::idx::ContainerIdx,
            (_, mut bytes): (loro_common::LoroValue, &[u8]),
            ctx: crate::internal::state::ContainerCreationContext,
