...
use crate::internal::sync::{Mutex, MutexGuard};
use crate::internal::{
    change::Lamport,
    container::{
        idx::ContainerIdx,
...
impl SharedArena {
    ...
    fn inner_convert_op(
        ...
        match content {
            crate::internal::op::RawOpContent::Map(MapSet { key, value }) => Op {
                counter,
                container,
                content: crate::internal::op::InnerContent::Map(MapSet { key, value }),
            },
            crate::internal::op::RawOpContent::List(list) => match list {
                ListOp::Insert { slice, pos } => match slice {
                    ListSlice::RawData(values) => {
                        ...
                        Op {
                            counter,
                            container,
                            content: crate::internal::op::InnerContent::List(InnerListOp::Insert {
                    ...
                    ListSlice::RawStr { str, unicode_len } => {
                        ...
                        Op {
                            counter,
                            container,
                            content: crate::internal::op::InnerContent::List(InnerListOp::InsertText {
                                slice,
                ...
                ListOp::Delete(span) => Op {
                    counter,
                    container,
                    content: crate::internal::op::InnerContent::List(InnerListOp::Delete(span)),
                },
                ListOp::StyleStart {
                    start,
                    end,
            ...
            crate::internal::op::RawOpContent::Tree(tree) => Op {
                counter,
                container,
                content: crate::internal::op::InnerContent::Tree(tree.clone()),
            },
            #[cfg(feature = "counter")]
            crate::internal::op::RawOpContent::Counter(c) => Op {
                counter,
                container,
                content: crate::internal::op::InnerContent::Future(crate::internal::op::FutureInnerContent::Counter(c)),
            },
            crate::internal::op::RawOpContent::Unknown { prop, value } => Op {
                counter,
                container,
                content: crate::internal::op::InnerContent::Future(crate::internal::op::FutureInnerContent::Unknown {
                    prop,
                    value: Box::new(value),
                }),
            },
