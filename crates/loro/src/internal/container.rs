...
//!
//! Every [Container] can take a [Snapshot], which contains [crate::internal::LoroValue] that describes the state.
//!
use crate::internal::{arena::SharedArena, InternalString, ID};
