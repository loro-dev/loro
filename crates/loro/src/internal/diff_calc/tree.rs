...
impl DiffCalculatorTrait for TreeDiffCalculator {
    fn start_tracking(&mut self, _oplog: &OpLog, _vv: &crate::internal::VersionVector, mode: DiffMode) {
        match mode {
            DiffMode::Checkout => {
        ...
        match &mut self.mode {
            ...
            | TreeDiffCalculatorMode::ImportGreaterUpdates(ref mut delta) => {
                ...
                let item: TreeDeltaItem = match &**content {
                    crate::internal::container::tree::tree_op::TreeOp::Create {
                        target,
                        parent,
                        position,
                    } => TreeDeltaItem {
                    ...
                    crate::internal::container::tree::tree_op::TreeOp::Move {
                        target,
                        parent,
                        position,
                    } => TreeDeltaItem {
                    ...
                    crate::internal::container::tree::tree_op::TreeOp::Delete { target } => TreeDeltaItem {
                        target: *target,
