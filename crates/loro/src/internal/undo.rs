...
use crate::internal::sync::{AtomicU64, Mutex};
use either::Either;
use loro_common::{
...
fn transform_cursor(
    ...
    match doc.get_handler(cid.clone()).unwrap() {
        crate::internal::handler::Handler::Text(h) => {
        ...
        crate::internal::handler::Handler::List(h) => {
        ...
        crate::internal::handler::Handler::MovableList(h) => {
            let Some(new_cursor) = h.get_cursor(new_pos, cursor_with_pos.pos.side) else {
                return;
            };
        ...
        crate::internal::handler::Handler::Map(_) => {}
        crate::internal::handler::Handler::Tree(_) => {}
        crate::internal::handler::Handler::Unknown(_) => {}
        #[cfg(feature = "counter")]
        crate::internal::handler::Handler::Counter(_) => {}
    }
}
