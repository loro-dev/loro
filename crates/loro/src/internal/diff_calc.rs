...
impl DiffCalculator {
    ...
    pub(crate) fn calc_diff_internal(
        ...
        before: &crate::internal::VersionVector,
        before_frontiers: &Frontiers,
        after: &crate::internal::VersionVector,
...
pub(crate) trait DiffCalculatorTrait {
    fn start_tracking(&mut self, oplog: &OpLog, vv: &crate::internal::VersionVector, mode: DiffMode);
    fn apply_change(
        &mut self,
        oplog: &OpLog,
        op: crate::internal::op::RichOp,
        vv: Option<&crate::internal::VersionVector>,
    );
    fn calculate_diff(
        &mut self,
        idx: ContainerIdx,
...
impl DiffCalculatorTrait for MapDiffCalculator {
    fn start_tracking(
        &mut self,
        _oplog: &crate::internal::OpLog,
        _vv: &crate::internal::VersionVector,
        mode: DiffMode,
    ) {
        self.changed.clear();
...
impl ListDiffCalculator {
    pub(crate) fn get_id_latest_pos(&self, id: ID) -> Option<crate::internal::cursor::AbsolutePosition> {
...
impl DiffCalculatorTrait for ListDiffCalculator {
    fn start_tracking(&mut self, _oplog: &OpLog, vv: &crate::internal::VersionVector, _mode: DiffMode) {
    ...
    fn apply_change(
        ...
        match &op.op().content {
            crate::internal::op::InnerContent::List(l) => match l {
...
impl DiffCalculatorTrait for RichtextDiffCalculator {
    fn start_tracking(
        ...
        vv: &crate::internal::VersionVector,
        mode: DiffMode,
    ) {
        match mode {
            DiffMode::Linear => {
...
impl DiffCalculatorTrait for MovableListDiffCalculator {
    fn start_tracking(&mut self, _oplog: &OpLog, vv: &crate::internal::VersionVector, mode: DiffMode) {
