...
use crate::internal::version::VersionRange;
use crate::internal::{
    arena::SharedArena,
...
pub(crate) use crate::internal::encoding::value_register::ValueRegister;
...
mod encode {
    ...
    pub(crate) fn get_op_prop(op: &Op, registers: &mut dyn ValueEncodeRegister) -> i32 {
        match &op.content {
            crate::internal::op::InnerContent::List(list) => match list {
                crate::internal::container::list::list_op::InnerListOp::Move { to, .. } => *to as i32,
                crate::internal::container::list::list_op::InnerListOp::Set { .. } => 0,
                crate::internal::container::list::list_op::InnerListOp::Insert { pos, .. } => *pos as i32,
                crate::internal::container::list::list_op::InnerListOp::InsertText { pos, .. } => *pos as i32,
                crate::internal::container::list::list_op::InnerListOp::Delete(span) => span.span.pos as i32,
                crate::internal::container::list::list_op::InnerListOp::StyleStart { start, .. } => {
                    *start as i32
                }
                crate::internal::container::list::list_op::InnerListOp::StyleEnd => 0,
            },
            crate::internal::op::InnerContent::Map(map) => {
                let key = registers.key_mut().register(&map.key);
                key as i32
            }
            crate::internal::op::InnerContent::Tree(_) => 0,
            crate::internal::op::InnerContent::Future(f) => get_future_op_prop(f),
        }
    }
    ...
    pub(crate) fn encode_op<'p, 'a: 'p>(
        ...
        let value = match &op.content {
            crate::internal::op::InnerContent::List(list) => match list {
                crate::internal::container::list::list_op::InnerListOp::Insert { slice, .. } => {
                    assert!(matches!(
                ...
                crate::internal::container::list::list_op::InnerListOp::InsertText { slice, .. } => {
                    Value::Str(std::str::from_utf8(slice.as_bytes()).unwrap())
                }
                crate::internal::container::list::list_op::InnerListOp::Delete(span) => {
                ...
                crate::internal::container::list::list_op::InnerListOp::StyleStart {
                    start,
                    end,
                    key,
                    value,
                ...
                crate::internal::container::list::list_op::InnerListOp::Set { elem_id, value } => {
                    Value::ListSet {
                ...
                crate::internal::container::list::list_op::InnerListOp::StyleEnd => Value::Null,
                crate::internal::container::list::list_op::InnerListOp::Move {
                    from,
                    elem_id: from_id,
                    to: _,
                } => Value::ListMove {
            ...
            crate::internal::op::InnerContent::Tree(t) => {
                assert_eq!(op.container.get_type(), ContainerType::Tree);
                registers.encode_tree_op(t)
            }
            crate::internal::op::InnerContent::Future(f) => match f {
                #[cfg(feature = "counter")]
...
pub(crate) fn decode_op(
    ...
    prop: i32,
    op_id: ID,
) -> LoroResult<crate::internal::op::InnerContent> {
    let content = match cid.container_type() {
        ContainerType::Text => match value {
            Value::Str(s) => {
                let (slice, result) = shared_arena.alloc_str_with_slice(s);
                crate::internal::op::InnerContent::List(
                    crate::internal::container::list::list_op::InnerListOp::InsertText {
                        slice,
            ...
            Value::DeleteSeq => {
                ...
                crate::internal::op::InnerContent::List(crate::internal::container::list::list_op::InnerListOp::Delete(
            ...
            Value::MarkStart(mark) => crate::internal::op::InnerContent::List(
                crate::internal::container::list::list_op::InnerListOp::StyleStart {
                    start: prop as u32,
            ...
            Value::Null => crate::internal::op::InnerContent::List(
                crate::internal::container::list::list_op::InnerListOp::StyleEnd,
            ),
            _ => unreachable!(),
        },
        ContainerType::Map => {
            ...
            match value {
                Value::DeleteOnce => {
                    crate::internal::op::InnerContent::Map(crate::internal::container::map::MapSet { key, value: None })
                }
                Value::LoroValue(v) => {
                    crate::internal::op::InnerContent::Map(crate::internal::container::map::MapSet {
                        key,
                        value: Some(v.clone()),
                    })
                }
        ...
        ContainerType::List => {
            ...
            match value {
                Value::LoroValue(arr) => {
                    ...
                    crate::internal::op::InnerContent::List(
                        crate::internal::container::list::list_op::InnerListOp::Insert {
                ...
                Value::DeleteSeq => {
                    ...
                    let len = del_start.len;
                    crate::internal::op::InnerContent::List(
                        crate::internal::container::list::list_op::InnerListOp::Delete(
                            DeleteSpanWithId::new(
                                ID::new(arenas.peers()[peer_idx], cnt as Counter),
                                pos as isize,
                                len,
        ...
        ContainerType::Tree => match value {
            Value::TreeMove(op) => crate::internal::op::InnerContent::Tree(Arc::new(
            ...
            Value::RawTreeMove(op) => {
                ...
                let parent = if op.is_parent_null {
                    ...
                    if parent_id.is_deleted_root() {
                        return Ok(crate::internal::op::InnerContent::Tree(Arc::new(TreeOp::Delete {
                            target: subject,
                        })));
                    }
                ...
                crate::internal::op::InnerContent::Tree(Arc::new(ans))
            }
            _ => {
                unreachable!()
            }
        ...
        ContainerType::MovableList => {
            ...
            match value {
                ...
                Value::ListSet {
                    ...
                    crate::internal::container::list::list_op::InnerListOp::Set {
        ...
        ContainerType::Counter => match value {
            Value::F64(c) => crate::internal::op::InnerContent::Future(FutureInnerContent::Counter(c)),
            Value::I64(c) => crate::internal::op::InnerContent::Future(FutureInnerContent::Counter(c as f64)),
            _ => unreachable!(),
        },
        // NOTE: The future container type need also try to parse the unknown type
        ContainerType::Unknown(_) => crate::internal::op::InnerContent::Future(FutureInnerContent::Unknown {
            prop,
