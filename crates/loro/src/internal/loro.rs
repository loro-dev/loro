use crate::internal::encoding::json_schema::{encode_change, export_json_in_id_span};
pub use crate::internal::encoding::ExportMode;
use crate::internal::pre_commit::{FirstCommitFromPeerCallback, FirstCommitFromPeerPayload};
pub use crate::internal::state::analyzer::{ContainerAnalysisInfo, DocAnalysis};
use crate::internal::sync::AtomicBool;
pub(crate) use crate::internal::LoroDocInner;
use crate::internal::{
    arena::SharedArena,
    change::Timestamp,
...
use crate::internal::{change::ChangeRef, lock::LockKind};
use crate::internal::{lock::LoroMutexGuard, pre_commit::PreCommitCallback};
use crate::internal::{
...
impl LoroDoc {
    ...
    pub fn import_json_updates<T: TryInto<JsonSchema>>(&self, json: T) -> LoroResult<ImportStatus> {
        ...
        self.with_barrier(|| {
            let result = self.update_oplog_and_apply_delta_to_state_if_needed(
                |oplog| crate::internal::encoding::json_schema::import_json(oplog, json),
                Default::default(),
            );
            self.emit_events();
            result
    ...
    pub fn export_json_updates(
        ...
        self.with_barrier(|| {
            ...
            crate::internal::encoding::json_schema::export_json(
                &oplog,
                start_vv,
                end_vv,
    ...
    pub fn get_counter<I: IntoContainerId>(
        &self,
        id: I,
    ) -> crate::internal::handler::counter::CounterHandler {
    ...
    pub fn undo_internal(
        ...
        let diff = crate::internal::undo::undo(
            spans,
        ...
        if let Some(ans) = state.get_relative_position(pos, ret_event_index) {
            ...
            let result = self.with_barrier(|| {
                ...
                if let Some(id) = pos.id {
                    ...
                    match diff_calc {
                        crate::internal::diff_calc::ContainerDiffCalculator::Richtext(text) => {
                        ...
                        crate::internal::diff_calc::ContainerDiffCalculator::List(list) => {
                        ...
                        crate::internal::diff_calc::ContainerDiffCalculator::MovableList(list) => {
                            let c = list.get_id_latest_pos(id).unwrap();
                            let new_pos = c.pos;
                        ...
                        crate::internal::diff_calc::ContainerDiffCalculator::Tree(_) => unreachable!(),
                        crate::internal::diff_calc::ContainerDiffCalculator::Map(_) => unreachable!(),
                        #[cfg(feature = "counter")]
                        crate::internal::diff_calc::ContainerDiffCalculator::Counter(_) => unreachable!(),
                        crate::internal::diff_calc::ContainerDiffCalculator::Unknown(_) => unreachable!(),
                    }
                } else {
...
#[cfg(test)]
mod test {
    use crate::internal::{cursor::PosType, loro::ExportMode, version::Frontiers, LoroDoc, ToJson};
    use loro_common::ID;
