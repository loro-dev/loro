...
use crate::internal::change::{get_sys_timestamp, Change, Lamport, Timestamp};
use crate::internal::configure::Configure;
use crate::internal::container::list::list_op;
use crate::internal::dag::{Dag, DagUtils};
use crate::internal::diff_calc::DiffMode;
use crate::internal::encoding::decode_oplog;
use crate::internal::encoding::{ImportStatus, ParsedHeaderAndBody};
use crate::internal::history_cache::ContainerHistoryCache;
use crate::internal::id::{Counter, PeerID, ID};
use crate::internal::op::{FutureInnerContent, ListSlice, RawOpContent, RemoteOp, RichOp};
use crate::internal::span::{HasCounterSpan, HasLamportSpan};
use crate::internal::version::{Frontiers, ImVersionVector, VersionVector};
use crate::internal::LoroError;
...
pub(crate) fn local_op_to_remote(
    ...
    match &op.content {
        ...
        crate::internal::op::InnerContent::Map(map) => {
            ...
            contents.push(RawOpContent::Map(crate::internal::container::map::MapSet {
                key: map.key.clone(),
                value,
            }))
        }
        crate::internal::op::InnerContent::Tree(tree) => contents.push(RawOpContent::Tree(tree.clone())),
        crate::internal::op::InnerContent::Future(f) => match f {
            #[cfg(feature = "counter")]
            crate::internal::op::FutureInnerContent::Counter(c) => contents.push(RawOpContent::Counter(*c)),
            FutureInnerContent::Unknown { prop, value } => {
                contents.push(crate::internal::op::RawOpContent::Unknown {
                    prop: *prop,
                    value: (**value).clone(),
                })
            }
