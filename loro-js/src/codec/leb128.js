...
export function readUleb128(reader, max = U64_MAX) {
    let result = 0n;
    let shift = 0n;
...
export function readUlebNumber(reader, max = Number.MAX_SAFE_INTEGER) {
...
export function writeUleb128(writer, input) {
...
export function readSleb128(reader) {
    let result = 0n;
    let shift = 0n;
    let byte = 0;
    const start = reader.position;
...
export function writeSleb128(writer, input) {
...
function numberToBigInt(value, name) {
