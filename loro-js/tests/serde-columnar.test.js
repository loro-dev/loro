...
import { decodeAnyRleU32, decodeBoolRle, decodeColumnarVec, decodeDeltaOfDeltaI64, decodeDeltaRleI32, decodeDeltaRleIsize, decodeDeltaRleU32, decodeDeltaRleUsize, decodeRleU8, encodeBoolRle, encodeColumnarVec, encodeDeltaOfDeltaI64, encodeDeltaRleI32, encodeDeltaRleIsize, encodeDeltaRleU32, encodeDeltaRleUsize, takeAnyRleU32, takeBoolRle, takeDeltaOfDeltaI64, bytesToHex, } from "../src/codec/index";
describe("serde-columnar", () => {
    ...
    test("preserves the canonical literal DeltaRle encoding", () => {
        expect(bytesToHex(encodeDeltaRleU32([10, 11, 12, 13, 15, 17]))).toBe("0b140202020404");
        expect(bytesToHex(encodeDeltaRleI32([-2, -1, 0, 5, 3]))).toBe("090302020a03");
    });
    test("round trips the full i32 and u32 delta range", () => {
        const unsigned = [0, 4294967295, 0, 4294967295];
        const signed = [-2147483648, 2147483647, -2147483648];
