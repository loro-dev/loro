...
import { EncodeMode, LoroDecodeError, bytesToHex, decodeDocument, decodeFastSnapshot, decodeFastUpdates, encodeDocument, encodeFastSnapshot, encodeFastUpdates, } from "../src/codec/index";
...
describe("FastSnapshot", () => {
    ...
    test("rejects trailing section bytes", () => {
        ...
        const withTrailing = encodeDocument(EncodeMode.FastSnapshot, new Uint8Array([...document.body, 0]));
